    ...
    <div className="grid h-screen place-items-center bg-black text-white ">
      ...
      <div className="flex justify-center items-center sm:flex-wraptext-center slide-in">
        ...
        <button className="hover:text-orange-500 sizeLinks h-20 flex-row align-middle font-Poppins font-extralight">
          <Link to="/devChat-City/api/login">Login</Link>
        </button>
        <button className="hover:text-sky-400 sizeLinks h-20 flex-row align-middle font-Poppins font-extralight">
          <Link to="/devChat-City/api/register">Register</Link>
        </button>
      </div>
      <br />
